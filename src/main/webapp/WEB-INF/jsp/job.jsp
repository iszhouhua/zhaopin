...
<!--内容栏start-->
	<div class="content">
		<div class="online">
			<div class="position" style="height:100px;margin-left:400px;color:#4ACC34;line-height:100px;font-size:24px;display:none;"></div>
...
<!-- 招聘统计 -->
<script type="text/javascript" src="js/searchJob.js"></script>
